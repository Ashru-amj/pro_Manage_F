        ...
        <div className={styles.sideBar}>
          ...
          <div className={styles.modesContainer}>
            <div className={styles.modes}>
              <div
                className={`${styles.mode} ${activeMode === "dashboard" ? styles.activeMode : ""
                  }`}
              ...
              <div
                className={`${styles.mode} ${activeMode === "analytics" ? styles.activeMode : ""
                  }`}
              ...
              <div
                className={`${styles.mode} ${activeMode === "setting" ? styles.activeMode : ""
                  }`}
